...
const Input = ({ placeholder, name, type, value, handleChange }) => (
    <input
        ...
        className="my-2 w-full p-2 outline-none bg-transparent text-white border-none rounded-lg text-sm white-glassmorphism"
    />
);
...
const Welcome = () => {
    ...
    const handleSubmit = (e) => {
        const { address, amount, keywork, message } = formData;
        e.preventDefault();
        console.log(formData);
        if (!address || !amount || !keywork || !message) {
        };
        sendTransaction();
    };
            ...
            <div className="flex mf:flex-row flex-col items-start justify-between md:p-20 py-12 px-4">
                <div className="flex flex-1 justify-start flex-col mf:mr-10">
                    ...
                    <p className="text-left mt-5 text-white font-light md:w-9/12 w-11/12 text-base">
                        Explore the world. Buy and sell cryptocurrencies easily on Krypto.
                    </p>
